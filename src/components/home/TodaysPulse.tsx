...
export const TodaysPulse = ({
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <div className="mx-2 mb-6 rounded-xl bg-gradient-to-b from-card-ombre-2 to-card-ombre-2-dark shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-border/20 overflow-hidden">
        {/* Header */}
