...
export const SmartQuickActions = ({
  ...
  return (
    <>
      <div className="mx-2 mb-3 rounded-xl bg-gradient-to-b from-card-ombre-3 to-card-ombre-3-dark shadow-[0_2px_10px_rgba(0,0,0,0.05)] border border-border/20 overflow-hidden">
