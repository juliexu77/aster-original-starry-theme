...
const translations = {
  en: {
    ...
    feedsConsistent: "Consistent feeds",
    rightOnRhythm: "On rhythm ({months}mo)",
    gettingStartedToday: "Starting today",
    lightFeedingDay: "Light day ({months}mo)",
    extraFeedsToday: "Extra feeds today",
    everyNapProgress: "Building habits",
    solidNapRhythm: "{baby} doing great",
    workingOnFirstNap: "First nap coming",
    shorterNapDay: "Short naps today",
    extraRestfulDay: "Extra rest today",
    earlyInDay: "Early day",
    moreRestComing: "More rest coming",
    extraRestToday: "Extra rest"
  },
  zh: {
    // App name and core  
    appName: "宝宝追踪器",
    ...
    feedsConsistent: "喂养一致",
    rightOnRhythm: "节奏正常 ({months}月)",
    gettingStartedToday: "今天开始",
    lightFeedingDay: "轻度 ({months}月)",
    extraFeedsToday: "额外喂养",
    everyNapProgress: "建立习惯",
    solidNapRhythm: "{baby}很好",
    workingOnFirstNap: "首次午睡",
    shorterNapDay: "短午睡",
    extraRestfulDay: "额外休息",
    earlyInDay: "早期",
    moreRestComing: "更多休息",
    extraRestToday: "额外休息"
  }
