...
const translations = {
  en: {
    ...
    feedsConsistent: "Feeds are consistent — steady days help build confident nights.",
    rightOnRhythm: "Right on rhythm for {months} months — steady days help build confident nights.",
    gettingStartedToday: "Just getting started today — every feed adds to your routine.",
    lightFeedingDay: "Light feeding day — still within healthy range for {months} months.",
    extraFeedsToday: "Extra feeds today — often a sign of growth spurt or comfort needs.",
    everyNapProgress: "Every nap is progress — building healthy sleep habits.",
    solidNapRhythm: "Solid nap rhythm — {baby} is practicing self-regulation beautifully.",
    workingOnFirstNap: "Working on today's first nap — every rest counts.",
    shorterNapDay: "Shorter nap day — normal during transitions and growth spurts.",
    extraRestfulDay: "Extra restful day — sometimes babies need more recovery time."
  },
  zh: {
    // App name and core  
    appName: "宝宝追踪器",
    ...
    feedsConsistent: "喂养稳定 — 平稳的白天有助于建立自信的夜晚。",
    rightOnRhythm: "{months} 个月的节奏恰到好处 — 平稳的白天有助于建立自信的夜晚。",
    gettingStartedToday: "刚开始今天的记录 — 每次喂养都为您的日常增添内容。",
    lightFeedingDay: "轻度喂养日 — 仍在 {months} 个月的健康范围内。",
    extraFeedsToday: "今天额外的喂养 — 通常是生长突增或安慰需求的迹象。",
    everyNapProgress: "每次午睡都是进步 — 建立健康的睡眠习惯。",
    solidNapRhythm: "扎实的午睡节奏 — {baby} 正在美妙地练习自我调节。",
    workingOnFirstNap: "正在进行今天的第一次午睡 — 每次休息都很重要。",
    shorterNapDay: "较短的午睡日 — 在过渡和成长突增期间很正常。",
    extraRestfulDay: "额外的休息日 — 有时宝宝需要更多的恢复时间。"
  }
};
